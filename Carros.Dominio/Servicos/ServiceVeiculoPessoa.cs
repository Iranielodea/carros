...
{
    public class ServiceVeiculoPessoa : ServiceBase<VeiculoPessoa>, IServiceVeiculoPessoa
    {
        private readonly IRepositoryVeiculoPessoa _repositorioVeiculoPessoa;

        public ServiceVeiculoPessoa(IRepositoryVeiculoPessoa repositorioVeiculoPessoa)
