...
{
    public class ServicoCadEncontro : ServicoBase<CadEncontro>, IServicoCadEncontro
    {
        private readonly IRepositorioCadEncontro _repositorioCadEncontro;

        public ServicoCadEncontro(IRepositorioCadEncontro repositorioCadEncontro)
