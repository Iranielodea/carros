...
{
    public class ServicoTabControle : ServicoBase<TabControle>, IServicoTabControle
    {
        private readonly IRepositorioTabControle _repositorioTabControle;

        public ServicoTabControle(IRepositorioTabControle repositorioTabControle)
