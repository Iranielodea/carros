...
{
    public class ServicoFiliacao : ServicoBase<Filiacao>, IServicoFiliacao
    {
        private readonly IRepositorioFiliacao _repositorioFiliacao;

        public ServicoFiliacao(IRepositorioFiliacao repositorioFiliacao)
