...
{
    public class ServicoSequencia : ServicoBase<Sequencia>, IServicoSequencia
    {
        private readonly IRepositorioSequencia _repositorioSequencia;

        public ServicoSequencia(IRepositorioSequencia repositorioSequencia)
